...
const config = {
  ...
  resolve: {
    ...
    alias: {
      ...
      // '@ant-design/icons/lib/dist$': paths.andIconImporter,
      'react-apollo-hooks': paths.reactApolloHooks,
    ...
    rules: [
      ...
      },
      {
        ...
        oneOf: [
          ...
          {
            test: /\.less$/,
            // exclude: path.join(paths.appNodeModules, '/),
            use: [
              {
                loader: 'style-loader'
              },
          ...
          // that fall through the other loaders.
          {
            ...
            exclude: [/\.(js|tsx|jsx|mjs)$/, /\.html$/, /\.json$/],
...
if (process.env.USE_DRAFT_ON_ANDROID) {
  config.resolve.alias = {
    ...config.resolve.alias,
    'draft-js': 'draft-js-android-fix'
  }
}
